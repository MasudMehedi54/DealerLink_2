...
public class RegisterScreen extends VBox {
    ...
    public RegisterScreen(Stage stage) {
        ...
        title.getStyleClass().addAll("app-title", "app-title-small");
        ...
        createBtn.setOnAction(e -> {
            ...
            // Latitude/longitude start at 0; GeocodingService looks up the typed city
            // (offline table in the JSON file, then the Open-Meteo API) the first time
            // weather is needed, and saves the result for this account.
